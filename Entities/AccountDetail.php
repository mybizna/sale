...
class AccountDetail extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ['label' => 'Account Detail Sale No', 'class' => 'col-span-full', 'fields' => ['sale_no']],
            ['label' => 'Account Details', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['trn_no', 'trn_date']],
            ['label' => 'Account Detail Amount', 'class' => 'col-span-full  md:col-span-6 md:pr-2', 'fields' => ['debit', 'credit']],
            ['label' => 'Account Detail Particulars', 'class' => 'col-span-full', 'fields' => ['particulars']],
        ];
