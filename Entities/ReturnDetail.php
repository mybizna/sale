...
class ReturnDetail extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ...
            ['label' => 'Return', 'class' => 'col-span-full md:col-span-6', 'fields' => ['invoice_details_id', 'product_id', 'qty', 'unit_price']],
            ['label' => 'Setting', 'class' => 'col-span-full md:col-span-6', 'fields' => ['discount', 'tax', 'item_total', 'ecommerce_type']],
        ];
