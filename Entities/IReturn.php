...
class IReturn extends BaseModel
{
    ...
    public function structure($structure): array
    {
        ...
        $structure['form'] = [
            ...
            ['label' => 'IReturn', 'class' => 'col-span-full md:col-span-6', 'fields' => ['invoice_id', 'vendor_id', 'vendor_name', 'trn_date', 'amount']],
            ['label' => 'IReturn', 'class' => 'col-span-full md:col-span-6', 'fields' => ['discount', 'discount_type', 'tax', 'status']],
